...
public class Entity {
	...
	public static enum AnimationType {
		...
		FALL_DOWN, FALL_LEFT, FALL_RIGHT, FALL_UP, REACH_LEFT, REACH_RIGHT,

		THINK, FORCEFIELD, SLEEP_LOOP,
		LOVE_ON, SHOCK_ON, QUESTION_ON, SLEEP_ON, SMUG_ON, HAPPY_ON, VERY_HAPPY_ON, NEUTRAL_ON, SAD_ON, CRY_ON, TEAR_ON, ANGER_ON,
		LOVE_OFF, SHOCK_OFF, QUESTION_OFF, SLEEP_OFF, SMUG_OFF, HAPPY_OFF, VERY_HAPPY_OFF, NEUTRAL_OFF, SAD_OFF, CRY_OFF, TEAR_OFF, ANGER_OFF,
