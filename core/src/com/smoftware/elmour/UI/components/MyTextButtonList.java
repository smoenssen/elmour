 ...
 * @author mzechner
 * @author Nathan Sweet */
public class MyTextButtonList<T> extends Widget implements Cullable {
    ...
    public MyTextButtonList(Skin skin) {
        this(skin.get(ListStyle.class));
    }

    public MyTextButtonList(Skin skin, String styleName) {
        this(skin.get(styleName, ListStyle.class));
    }

    public MyTextButtonList(ListStyle style) {
        ...
        addListener(new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (selection.getMultiple()) getStage().setKeyboardFocus(MyTextButtonList.this);
                MyTextButtonList.this.touchDown(y);
                return true;
            }
        });
    }
    ...
    protected GlyphLayout drawItem (Batch batch, BitmapFont font, int index, T item, float x, float y) {
        ...
        return font.draw(batch, button.getText(), x, y);
    ...
    /** The style for a list, see {@link MyTextButtonList}.
     * @author mzechner
     * @author Nathan Sweet */
