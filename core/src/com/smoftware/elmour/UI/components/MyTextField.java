 ...
 * <p>
 * The preferred height of a text field is the height of the {@link MyTextField.TextFieldStyle#font} and {@link MyTextField.TextFieldStyle#background}.
 ...
 * supported yet.
 * <p>
 * The text field allows you to specify an {@link MyTextField.OnscreenKeyboard} for displaying a softkeyboard and piping all key events
 ...
 * The desktop keyboard is a stub, as a softkeyboard is not needed on the desktop. The Android {@link MyTextField.OnscreenKeyboard}
...
public class MyTextField extends Widget implements Disableable {
    ...
    protected MyTextField.TextFieldStyle style;
    private String messageText;
    protected CharSequence displayText;
    Clipboard clipboard;
    InputListener inputListener;
    MyTextField.TextFieldListener listener;
    MyTextField.TextFieldFilter filter;
    MyTextField.OnscreenKeyboard keyboard = new MyTextField.DefaultOnscreenKeyboard();
    ...
    MyTextField.KeyRepeatTask keyRepeatTask = new MyTextField.KeyRepeatTask();
    boolean programmaticChangeEvents;

    public MyTextField (String text, Skin skin) {
        this(text, skin.get(MyTextField.TextFieldStyle.class));
    }

    public MyTextField (String text, Skin skin, String styleName) {
        this(text, skin.get(styleName, MyTextField.TextFieldStyle.class));
    }

    public MyTextField (String text, MyTextField.TextFieldStyle style) {
        setStyle(style);
    ...
    protected InputListener createInputListener () {
        return new MyTextField.TextFieldClickListener();
    }
    ...
    public void setStyle (MyTextField.TextFieldStyle style) {
    ...
    /** Returns the text field's style. Modifying the returned style may not have an effect until {@link #setStyle(MyTextField.TextFieldStyle)}
     * is called. */
    public MyTextField.TextFieldStyle getStyle () {
        return style;
    }
    ...
    public void next (boolean up) {
        ...
        while (true) {
            ...
            MyTextField textField = current.findNextTextField(stage.getActors(), null, tmp2, tmp1, up);
    ...
    private MyTextField findNextTextField (Array<Actor> actors, MyTextField best, Vector2 bestCoords, Vector2 currentCoords,
                                           boolean up) {
        for (int i = 0, n = actors.size; i < n; i++) {
            Actor actor = actors.get(i);
            if (actor == this) continue;
            if (actor instanceof MyTextField) {
                MyTextField textField = (MyTextField)actor;
    ...
    public void setTextFieldListener (MyTextField.TextFieldListener listener) {
        this.listener = listener;
    }

    /** @param filter May be null. */
    public void setTextFieldFilter (MyTextField.TextFieldFilter filter) {
        this.filter = filter;
    }

    public MyTextField.TextFieldFilter getTextFieldFilter () {
        return filter;
    }
    ...
    /** Default is an instance of {@link MyTextField.DefaultOnscreenKeyboard}. */
    public MyTextField.OnscreenKeyboard getOnscreenKeyboard () {
        return keyboard;
    }

    public void setOnscreenKeyboard (MyTextField.OnscreenKeyboard keyboard) {
    ...
    static public interface TextFieldListener {
        public void keyTyped (MyTextField textField, char c);
    }

    /** Interface for filtering characters entered into the text field.
     * @author mzechner */
    static public interface TextFieldFilter {
        public boolean acceptChar (MyTextField textField, char c);

        static public class DigitsOnlyFilter implements MyTextField.TextFieldFilter {
            @Override
            public boolean acceptChar (MyTextField textField, char c) {
    ...
    /** The default {@link MyTextField.OnscreenKeyboard} used by all {@link MyTextField} instances. Just uses
     * {@link Input#setOnscreenKeyboardVisible(boolean)} as appropriate. Might overlap your actual rendering, so use with care!
     * @author mzechner */
    static public class DefaultOnscreenKeyboard implements MyTextField.OnscreenKeyboard {
        @Override
        public void show (boolean visible) {
            ...
            if ((character == TAB || character == ENTER_ANDROID) && focusTraversal) {
                ...
                if (add || remove) {
                    ...
                    if (add && !remove) {
                        ...
                        if (!enter && filter != null && !filter.acceptChar(MyTextField.this, character)) return true;
    ...
    /** The style for a text field, see {@link MyTextField}.
     * @author mzechner
     * @author Nathan Sweet */
    static public class TextFieldStyle {
        ...
        public TextFieldStyle (MyTextField.TextFieldStyle style) {
