 ...
 * <p>
 * The preferred height of a text field is the height of the {@link com.smoftware.elmour.UI.MyTextField.TextFieldStyle#font} and {@link com.smoftware.elmour.UI.MyTextField.TextFieldStyle#background}.
 ...
 * supported yet.
 * <p>
 * The text field allows you to specify an {@link com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard} for displaying a softkeyboard and piping all key events
 ...
 * The desktop keyboard is a stub, as a softkeyboard is not needed on the desktop. The Android {@link com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard}
 * implementation will bring up the default IME.
 * @author mzechner
 * @author Nathan Sweet */
public class MyTextField extends Widget implements Disableable {
    ...
    com.smoftware.elmour.UI.MyTextField.TextFieldStyle style;
    private String messageText;
    protected CharSequence displayText;
    Clipboard clipboard;
    InputListener inputListener;
    com.smoftware.elmour.UI.MyTextField.TextFieldListener listener;
    com.smoftware.elmour.UI.MyTextField.TextFieldFilter filter;
    com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard keyboard = new com.smoftware.elmour.UI.MyTextField.DefaultOnscreenKeyboard();
    ...
    com.smoftware.elmour.UI.MyTextField.KeyRepeatTask keyRepeatTask = new com.smoftware.elmour.UI.MyTextField.KeyRepeatTask();
    boolean programmaticChangeEvents;

    public MyTextField (String text, Skin skin) {
        this(text, skin.get(com.smoftware.elmour.UI.MyTextField.TextFieldStyle.class));
    }

    public MyTextField (String text, Skin skin, String styleName) {
        this(text, skin.get(styleName, com.smoftware.elmour.UI.MyTextField.TextFieldStyle.class));
    }

    public MyTextField (String text, com.smoftware.elmour.UI.MyTextField.TextFieldStyle style) {
        setStyle(style);
    ...
    protected InputListener createInputListener () {
        return new com.smoftware.elmour.UI.MyTextField.TextFieldClickListener();
    }
    ...
    public void setStyle (com.smoftware.elmour.UI.MyTextField.TextFieldStyle style) {
    ...
    /** Returns the text field's style. Modifying the returned style may not have an effect until {@link #setStyle(com.smoftware.elmour.UI.MyTextField.TextFieldStyle)}
     * is called. */
    public com.smoftware.elmour.UI.MyTextField.TextFieldStyle getStyle () {
        return style;
    }
    ...
    void paste (String content, boolean fireChangeEvent, boolean updateDisplay) {
    ...
    public void next (boolean up) {
        ...
        com.smoftware.elmour.UI.MyTextField current = this;
        while (true) {
            current.getParent().localToStageCoordinates(tmp1.set(getX(), getY()));
            com.smoftware.elmour.UI.MyTextField textField = current.findNextTextField(stage.getActors(), null, tmp2, tmp1, up);
    ...
    private com.smoftware.elmour.UI.MyTextField findNextTextField (Array<Actor> actors, com.smoftware.elmour.UI.MyTextField best, Vector2 bestCoords, Vector2 currentCoords,
                                                                            boolean up) {
        for (int i = 0, n = actors.size; i < n; i++) {
            Actor actor = actors.get(i);
            if (actor == this) continue;
            if (actor instanceof com.smoftware.elmour.UI.MyTextField) {
                com.smoftware.elmour.UI.MyTextField textField = (com.smoftware.elmour.UI.MyTextField)actor;
                ...
                if ((actorCoords.y < currentCoords.y || (actorCoords.y == currentCoords.y && actorCoords.x > currentCoords.x)) ^ up) {
                    if (best == null
                        ...
                        best = (com.smoftware.elmour.UI.MyTextField)actor;
    ...
    public void setTextFieldListener (com.smoftware.elmour.UI.MyTextField.TextFieldListener listener) {
        this.listener = listener;
    }

    /** @param filter May be null. */
    public void setTextFieldFilter (com.smoftware.elmour.UI.MyTextField.TextFieldFilter filter) {
        this.filter = filter;
    }

    public com.smoftware.elmour.UI.MyTextField.TextFieldFilter getTextFieldFilter () {
        return filter;
    }
    ...
    /** Default is an instance of {@link com.smoftware.elmour.UI.MyTextField.DefaultOnscreenKeyboard}. */
    public com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard getOnscreenKeyboard () {
        return keyboard;
    }

    public void setOnscreenKeyboard (com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard keyboard) {
    ...
    static public interface TextFieldListener {
        public void keyTyped (com.smoftware.elmour.UI.MyTextField textField, char c);
    }

    /** Interface for filtering characters entered into the text field.
     * @author mzechner */
    static public interface TextFieldFilter {
        public boolean acceptChar (com.smoftware.elmour.UI.MyTextField textField, char c);

        static public class DigitsOnlyFilter implements com.smoftware.elmour.UI.MyTextField.TextFieldFilter {
            @Override
            public boolean acceptChar (com.smoftware.elmour.UI.MyTextField textField, char c) {
    ...
    /** The default {@link com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard} used by all {@link com.smoftware.elmour.UI.MyTextField} instances. Just uses
     * {@link Input#setOnscreenKeyboardVisible(boolean)} as appropriate. Might overlap your actual rendering, so use with care!
     * @author mzechner */
    static public class DefaultOnscreenKeyboard implements com.smoftware.elmour.UI.MyTextField.OnscreenKeyboard {
        @Override
        public void show (boolean visible) {
    ...
    public class TextFieldClickListener extends ClickListener {
        ...
        public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
            ...
            Stage stage = getStage();
            if (stage != null) stage.setKeyboardFocus(com.smoftware.elmour.UI.MyTextField.this);
            keyboard.show(true);
            hasSelection = true;
            return true;
        }
        ...
        public boolean keyDown (InputEvent event, int keycode) {
            ...
            Stage stage = getStage();
            if (stage == null || stage.getKeyboardFocus() != com.smoftware.elmour.UI.MyTextField.this) return false;
            ...
            if (UIUtils.shift()) {
                if (keycode == Keys.INSERT) paste(clipboard.getContents(), true, true);
        ...
        public boolean keyTyped (InputEvent event, char character) {
            ...
            if ((character == TAB || character == ENTER_ANDROID) && focusTraversal) {
                ...
                if (add || remove) {
                    ...
                    if (add && !remove) {
                        ...
                        if (!enter && filter != null && !filter.acceptChar(com.smoftware.elmour.UI.MyTextField.this, character)) return true;
            ...
            if (listener != null) listener.keyTyped(com.smoftware.elmour.UI.MyTextField.this, character);
            return true;
        }
    }

    /** The style for a text field, see {@link com.smoftware.elmour.UI.MyTextField}.
     * @author mzechner
     * @author Nathan Sweet */
    static public class TextFieldStyle {
        ...
        public TextFieldStyle (com.smoftware.elmour.UI.MyTextField.TextFieldStyle style) {
